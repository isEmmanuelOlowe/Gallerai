    ...
    <div className="min-h-screen">
      <div className="">
        ...
        <div className="flex items-center flex-wrap h-[70vh] ease-in-out duration-1000">
            <div className="hidden pt-4 pb-2 m-auto font-serif text-4xl text-center duration-200 ease-in-out md:block">{panels.current? panels.current.currentPanel? articles[panels.current.currentPanel.getIndex()]? articles[panels.current.currentPanel.getIndex()].title: articles[0].title: articles[0].title: articles[0].title}</div>
