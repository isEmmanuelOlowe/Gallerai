    ...
    return (
        <>
                ...
                <div className="relative mx-auto text-gray-600 lg:block">
                    <input className={`h-10 pl-4 pr-8 text-sm bg-transparent border-none focus:outline-none focus:ring-black focus:ring-2 focus:rounded-full focus:${(scrollY > 1)? "text-black": text}`} type="search" name="search" placeholder="Search" />
